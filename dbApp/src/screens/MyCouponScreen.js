...
const MyCouponScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    // สร้างข้อมูลคูปองตัวอย่างแทนการดึงจาก Firebase
    const demoCoupons = [
      {
        id: '1',
      ...
      {
        id: '2',
        createdDate: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), // 5 วันที่แล้ว
        expiryDate: new Date(Date.now() + 25 * 24 * 60 * 60 * 1000).toISOString(), // 25 วันเหลือ
      ...
      {
        id: '3',
        createdDate: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), // 2 วันที่แล้ว
        expiryDate: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000).toISOString(), // 28 วันเหลือ
